		...
		if(isset($_POST["usuario-Ing"])){
			...
			if(preg_match('/^[a-zA-Z0-9]+$/', $_POST["usuario-Ing"]) && preg_match('/^[a-zA-Z0-9]+$/', $_POST["clave-Ing"])){
				...
				if($resultado != false){
					...
					$resultado2 = AdminM::IngresarAdmin2M($tablaBD, $datosC);

					var_dump($resultado2);

					if($resultado2["usuario"] == $_POST["usuario-Ing"] && $resultado2["clave"] == $_POST["clave-Ing"]){

						$_SESSION["Ingresar"] = true;

						$_SESSION["id"] = $resultado2["id"];
						$_SESSION["usuario"] = $resultado2["usuario"];
						$_SESSION["clave"] = $resultado2["clave"];
						$_SESSION["nombre"] = $resultado2["nombre"];
						$_SESSION["apellido"] = $resultado2["apellido"];
