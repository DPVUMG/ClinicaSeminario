	...
	public function VerPerfilSecretariaC(){
		...
		echo '<tr>
				...
				if($resultado["foto"] != ""){
					...
					echo '<td><img src="http://67.205.147.53/centros/'.$resultado["foto"].'" class="img-responsive" width="40px"></td>';

				}else{

					echo '<td><img src="http://67.205.147.53/centros/vistas/img/defecto.png" class="img-responsive" width="40px"></td>';
				...
				echo '<td>
					...
					<a href="http://67.205.147.53/centros/perfil-S/'.$resultado["id"].'">
				...
				<div class="row">
					...
					<div class="col-md-6 col-xs-12">
						...
						if($resultado["foto"] == ""){
							...
							echo '<img src="http://67.205.147.53/centros/vistas/img/defecto.png" width="200px;">';

						}else{

							echo '<img src="http://67.205.147.53/centros/'.$resultado["foto"].'" width="200px;">';
	...
	public function ActualizarPerfilSecretariaC(){
		...
		if(isset($_POST["idP"])){
			...
			if($resultado == true){
				...
				window.location = "http://67.205.147.53/centros/perfil-S/'.$_SESSION["id"].'";
				</script>';
