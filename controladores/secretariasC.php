	...
	public function VerPerfilSecretariaC(){
		...
		echo '<tr>
				...
				if($resultado["foto"] != ""){
					...
					echo '<td><img src="http://67.205.147.53/clinica/'.$resultado["foto"].'" class="img-responsive" width="40px"></td>';
				...
				echo '<td>
					...
					<a href="http://67.205.147.53/clinica/perfil-S/'.$resultado["id"].'">
	...
	public function ActualizarPerfilSecretariaC(){
		...
		if(isset($_POST["idP"])){
			...
			if($resultado == true){
				...
				window.location = "http://67.205.147.53/clinica/perfil-S/'.$_SESSION["id"].'";
				</script>';
