	...
	public function VerPerfilSecretariaC(){
		...
		echo '<tr>
				...
				if($resultado["foto"] != ""){
					...
					echo '<td><img src="http://localhost/centros/'.$resultado["foto"].'" class="img-responsive" width="40px"></td>';
				...
				echo '<td>
					...
					<a href="http://localhost/centros/perfil-S/'.$resultado["id"].'">
	...
	public function ActualizarPerfilSecretariaC(){
		...
		if(isset($_POST["idP"])){
			...
			if($resultado == true){
				...
				window.location = "http://localhost/centros/perfil-S/'.$_SESSION["id"].'";
				</script>';
