...
<div class="modal fade" rol="dialog" id="EventoModal">
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<form method="post">
				...
				<div class="modal-body">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input type="hidden" class="" id="idCita" value="" name="id_Cita" readonly>
				...
				$cancelarC = new CitasC();
				$cancelarC -> CancelarCitaC();
